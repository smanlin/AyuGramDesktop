...
inline QString AyuHantHelper(const QString &key, const QString &fallback) {
	static const QMap<QString, QString> dict = {
		...
		{"ayu_SettingsShowViewJson", "顯示 [查看 JSON] 選項"},
		...
		{"ayu_YukiGramHeader", "YukiGram 增強功能"},
		{"ayu_SettingsShowMessageID", "顯示訊息 ID (在時間旁)"},
		...
		{"forum-hide-chats-list", "隱藏論壇中的對話列表"},
		{"forum-hide-chats-list_desc", "不要保留狹窄的對話列表欄位。"},
		{"fractional-scaling", "啟用分數縮放 (Fractional Scaling)"},
		{"view-profile-in-chats-list-context-menu", "在對話列表右鍵選單中顯示「查看個人資料」"},
		{"view-profile-in-chats-list-context-menu_desc", "在對話列表的右鍵選單中增加「查看個人資料」選項"},
		{"show-peer-id-below-about", "在簡介下方顯示 Peer ID"},
		{"show-channel-joined-below-about", "在簡介下方顯示頻道加入日期"},
		{"use-small-msg-bubble-radius", "使用小圓角訊息氣泡"},
		{"disable-autoplay-next", "停用自動播放下一個媒體"},
		{"send-large-photos", "發送原始尺寸圖片 (不壓縮)"},
		{"send-large-photos_desc", "允許發送邊長超過 2560px 的圖片。"},
		{"webview-debug-enabled", "啟用 Webview 除錯模式"},
		{"webview-debug-enabled_desc", "在 Webview 右鍵選單中啟用檢查元素功能。"},
		{"webview-legacy-edge", "使用舊版 Edge Webview"},
		{"auto-scroll-inactive-chat", "自動捲動非活動對話"},
		{"hide-reply-button", "隱藏回覆按鈕"},
		{"custom-notification", "使用自訂通知視窗"},
		{"gnotification", "使用原生通知 (GNotification)"},
		{"freetype", "使用 FreeType 字型渲染"},
		{"skip-url-scheme-register", "跳過 URL Scheme 註冊"},
		{"external-video-player", "使用外部影片播放器"},
		{"new-windows-size-as-first", "新視窗大小與第一個視窗相同"},
		{"prefer-ipv6", "優先使用 IPv6"},
		{"fast-buttons-mode", "快速按鈕模式"},
		{"touchbar-disabled", "停用 Touch Bar"},
		{"alternative-scroll-processing", "替代捲動處理邏輯"},
		// New Experimental Keys
		// {"forum-hide-chats-list", "隱藏論壇中的對話列表"}, // Already added
		{"fractional-scaling-enabled", "啟用分數縮放"},
		{"view-profile-in-chats-list-context-menu", "在對話列表右鍵選單中顯示「查看個人資料」"},
		{"show-channel-joined-below-about", "在簡介下方顯示頻道加入日期"},
		{"use-small-msg-bubble-radius", "使用小圓角訊息氣泡"},
		{"disable-autoplay-next", "停用自動播放下一個媒體"},
		{"send-large-photos", "發送原始尺寸圖片"},
		{"webview-debug-enabled", "啟用 Webview 除錯模式"},
		{"webview-legacy-edge", "使用舊版 Edge Webview"},
		{"auto-scroll-inactive-chat", "自動捲動非活動對話"},
		{"hide-reply-button", "隱藏回覆按鈕"},
